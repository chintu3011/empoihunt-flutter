...
import 'package:emploiflutter/ui/applied_candidate_profile/applied_candidate_profile.dart';
...
class AppliedCandidateListTile extends StatelessWidget {
  const AppliedCandidateListTile({super.key});
      ...
      child: Stack(
        ...
        children: [
          Container(
            ...
            child:  InkWell(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (_)=>const AppliedCandidateProfile()));
              },
              child: Row(
                children: [
          ...
          const AppliedCandidateProfileCard(),
