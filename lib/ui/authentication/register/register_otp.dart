...
class _RegisterOTPState extends ConsumerState<RegisterOTP> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((timeStamp) async{
      await ref.read(registerOtpController).verifyPhoneNumber(phoneNumber: widget.phoneNumber, context: context, selectedUserType: ref.read(chooseUserRoleController).selectedUserType!,childCurrent: widget);
    });
  }
  @override
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Pinput(
                      ...
                      length: 6,
                      onCompleted: (val){
                        registerOtpWatch.verifyOtp(context: context, selectedUserType: chooseUserRoleWatch.selectedUserType!,childCurrent: widget);
                      },
                  ...
                  CommonButton(btnText: "Verify", onPressed: ()async{
                    ...
                    await registerOtpWatch.verifyOtp(context: context, selectedUserType:chooseUserRoleWatch.selectedUserType! ,childCurrent: widget);
