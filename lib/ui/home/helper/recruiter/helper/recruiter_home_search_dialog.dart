...
class RecruiterHomeSearchDialog extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final recruiter = ref.watch(recruiterHomeController);
    return Container(
      height: 280.h,
      ...
      child: Column(
        children: [
          AvatarGlow(
            endRadius: 75.0.r,
            animate: recruiter.isVoiceListening,
          ...
          Expanded(child: Text(recruiter.searchController.text,style: TextStyles.w500.copyWith(fontSize: 12.sp,color: Colors.black),)),
